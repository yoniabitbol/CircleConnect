...
const ApplyDropUp: FC<{ postSettings: any; postId: string }> = (props) => {
  ...
  const checkIfCanApply = () => {
    ...
    if (
      postSettings.isCoverLetterRequired &&
      !formik.values.applicationCoverLetter
    ) {
      return false;
    }
    return true;
          ...
          <KeyboardArrowDownIcon
            sx={{
              ...
              "&:hover": {
                ...
                filter: "drop-shadow(0px 0px 2px #6947C3)",
              },
            }}
          />
        </IconButton>
        ...
        <div className="h-[25rem] sm:w-[30rem] w-[21rem] px-1 flex-col justify-center">
          ...
          <form className="flex-col" onSubmit={formik.handleSubmit}>
            <div className="flex items-center w-full">
              ...
              {postSettings.isResumeRequired &&
                !formik.values.applicationResume && (
                  <span className="items-center absolute right-2 text-red-400">
                    Required
                  </span>
                )}
              <div className="items-center absolute right-2 text-red-400">
                {formik.values.applicationResume && (
                  <CheckCircleRounded sx={{ color: "#0dcc0f" }} />
                )}
              </div>
            </div>
            <div className="flex items-center w-full">
            ...
            {!success && (
              <Button
                ...
                sx={{
                  ...
                  fontSize: 20,
                  width: "100%",
                  backgroundColor: `${canApply ? "#4D47C3" : "gray"}`,
                  color: "white",
                  "&:hover": { backgroundColor: "#3a32c2" },
                }}
                variant="text"
                type="submit"
              >
          ...
          {!success ? (
            ...
            <h1 className="w-full text-center text-2xl text-green-500 mt-20">
              {" "}
