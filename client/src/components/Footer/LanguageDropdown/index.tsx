...
const LanguageDropdown: React.FC = () => {
  ...
  return (
    ...
    <div className="flex items-center md:order-2">
        <button type="button" data-dropdown-toggle="language-dropdown-menu" className="inline-flex items-center justify-center px-4 py-2 text-sm rounded-lg cursor-pointer hover:text-gray-900 hover:bg-gray-100 light:hover:bg-gray-700 light:hover:text-white"
        onClick={() =>{
          setLanguage("en");
          ...
          <button 
            ...
            className="inline-flex items-center justify-center px-4 py-2 text-sm  rounded-lg cursor-pointer hover:text-gray-900 hover:bg-gray-100 light:hover:bg-gray-700 light:hover:text-white"
