                        ...
                        <form onSubmit={formik.handleSubmit}>
                            ...
                            <CardActions className="fixed bottom-0 flex w-full p-2 z-20">
                                <div className="flex w-1/3 items-center space-x-0">
                                    ...
                                    <FormControlLabel name="isJobPosting"  control={<Checkbox onChange={formik.handleChange} checked={formik.values.isJobPosting} defaultChecked sx={{color:'#4D47C3','&.Mui-checked': {color: '#4D47C3'},'label':{width: 'fit-content', color: 'red'}}}/>} color='success' label="Job posting"/>
                                </div>
