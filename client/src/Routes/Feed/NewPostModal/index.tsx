                     ...
                     <TextareaAutosize name="text" onChange={formik.handleChange} value={formik.values.text} minRows={textAreaRows} maxRows={textAreaRows} className="w-full  outline-none relative resize-none" placeholder={t('common.label.onYourMind') || "Whats on your mind?"}/>
                        ...
                        <CardActions className="fixed bottom-0 w-full p-2 z-20 flex">
                            <div className="w-fit flex justify-start">
                                <FormControlLabel name="isJobListing" control={<Checkbox onChange={formik.handleChange}
                                ...
                                <IconButton disabled={!formik.values.isJobListing} sx={{
                                    marginRight: 50,
                            ...
                            <div className="fixed right-0 bottom-1 flex space-x-1 px-2 justify-end">
                                <IconButton disabled={!formik.values.isJobListing}
