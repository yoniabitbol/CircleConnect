...
class PlaywrightConnection {
  ...
  async _initPlaywrightTetheringMode(scope) {
    var _this$_preLaunched$sh;
    this._debugLog(`engaged playwright.tethering mode`);
    const playwright = (0, _server.createPlaywright)('javascript');
    (_this$_preLaunched$sh = this._preLaunched.sharedSocksProxy) === null || _this$_preLaunched$sh === void 0 ? void 0 : _this$_preLaunched$sh.setPattern(this._options.socksProxyPattern);
    // Tethering client owns the shared socks proxy.
    return new _server.PlaywrightDispatcher(scope, playwright, this._preLaunched.sharedSocksProxy);
  }
  ...
  async _initPreLaunchedBrowserMode(scope) {
    var _this$_preLaunched$ow, _this$_preLaunched$ow2;
    ...
    playwright.options.socksProxyPort = (_this$_preLaunched$ow = this._preLaunched.ownedSocksProxy) === null || _this$_preLaunched$ow === void 0 ? void 0 : _this$_preLaunched$ow.port();
    (_this$_preLaunched$ow2 = this._preLaunched.ownedSocksProxy) === null || _this$_preLaunched$ow2 === void 0 ? void 0 : _this$_preLaunched$ow2.setPattern(this._options.socksProxyPattern);
    ...
    const playwrightDispatcher = new _server.PlaywrightDispatcher(scope, playwright, this._preLaunched.ownedSocksProxy, browser);
  ...
  async _initReuseBrowsersMode(scope) {
    var _this$_preLaunched$sh2;
    this._debugLog(`engaged reuse browsers mode for ${this._options.browserName}`);
    const playwright = this._preLaunched.playwright;

    // Note: connected client owns the socks proxy and configures the pattern.
    playwright.options.socksProxyPort = (_this$_preLaunched$sh2 = this._preLaunched.sharedSocksProxy) === null || _this$_preLaunched$sh2 === void 0 ? void 0 : _this$_preLaunched$sh2.port();
    this._debugLog(`using shared socks proxy on port ${playwright.options.socksProxyPort}`);
